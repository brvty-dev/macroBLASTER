...
bulkB.addEventListener("click", () => {
  ...
  selectButton(bulkB, goalButtonsB);
});
...
let bmrB;
let bmrMale = (10 * numericWeightB) + (6.25 * numericHeightB) - (5 * numericAgeB) + 5;
let bmrFemale = (10 * numericWeightB) + (6.25 * numericHeightB) - (5 * numericAgeB) - 161;
    ...
    <table>
      ...
      <p>
        * Sugar-free soft drinks as well as tea and coffee made with fat-free milk can all be included in your water intake.
        ...
        <a href="index.html" class="reload_b" id="reload" aria-label="Return to macroBLASTER's home page">
          Reload
        </a>
`;
}